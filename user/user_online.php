                                ...
                                <div class="user-name mr-30">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userName">
                                            <a class="dropdown-item" href="dashboard.php"><i class="fa fa-laptop"></i>&nbsp;Dashboard</a>
                                            <a class="dropdown-item" href="settings.php"><i class="fa fa-cog fa-spin"></i>&nbsp;Settings</a>
                                            <a class="dropdown-item" href="../logout.php"><i class="fa fa-door"></i>Logout</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="userthumb mr-30">
                                    <img src="usr_image/'.$userImg.'" alt="">
                                </div>';
